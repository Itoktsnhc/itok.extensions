...
namespace Itok.Extensions.Misc
{
    ...
    /// <see cref="https://github.com/dotnet/orleans/blob/10af0f4af588cd4aa45cb3e250dfbffa389d59c7/src/Orleans.Core/Utils/LRU.cs"/>
    /// </summary>
    /// <typeparam name="TKey"></typeparam>
    /// <typeparam name="TValue"></typeparam>
    public class LRU<TKey, TValue> : IEnumerable<KeyValuePair<TKey, TValue>>
    {
        ...
        private readonly ConcurrentDictionary<TKey, TimestampedValue> cache = new ConcurrentDictionary<TKey, TimestampedValue>();
        private int count;
